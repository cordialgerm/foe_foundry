...
### post-84.md
**Title:** Undead Tactics: The Mummy Lord
- **Bard** (2 refs): Body: bards
- **Gnoll** (2 refs): Body: gnoll
...
- **Spider** (1 refs): Body: spiders
- **Vampire** (1 refs): Body: vampire
- **Vampire Warrior** (1 refs): Body: vampire warriors
- **Warrior** (1 refs): Body: warriors

### post-850.md
**Title:** Vampire Warrior and Spellcaster Tactics
- **Mage** (1 refs): Body: mage
- **Vampire** (50 refs): **Headers: vampire**; Body: vampires, vampire 🎯
- **Vampire Spawn** (1 refs): Body: vampire spawn
- **Vampire Warrior** (1 refs): **Headers: vampire warrior** 🎯
- **Warrior** (7 refs): **Headers: warrior**; Body: warrior 🎯

### post-858.md
**Title:** Vargouille Tactics
- **Bat** (1 refs): Body: bat
- **Kobold** (1 refs): Body: kobolds
- **Rust Monster** (1 refs): Body: rust monsters
...
- **Duergar** (27 refs): **Headers: duergar**; Body: duergar 🎯

### post-879.md
**Title:** Catoblepas Tactics
- **Cat** (1 refs): Body: cat
...
### post-907.md
**Title:** Tarrasque Tactics
- **Cat** (1 refs): Body: cat
- **Tarrasque** (27 refs): **Headers: tarrasque**; Body: tarrasque, tarrasques 🎯

### post-929.md
**Title:** Thri-kreen Tactics
- **Peryton** (1 refs): Body: perytons
- **Soldier** (3 refs): Body: soldier
- **Warrior** (1 refs): Body: warriors

### post-944.md
**Title:** Modron Tactics
- **Phantom** (1 refs): Body: phantom
- **Soldier** (1 refs): Body: soldiers

### post-956.md
**Title:** Displacer Beast Tactics
- **Ape** (1 refs): Body: ape
- **Panther** (1 refs): Body: panther
- **Yeti** (1 refs): Body: yetis
...
### post-97.md
**Title:** Undead Tactics: Vampires
- **Bat** (7 refs): Body: bats, bat
- **Guard** (2 refs): Body: guards
- **Kobold** (1 refs): Body: kobolds
- **Lich** (1 refs): Body: liches
- **Lion** (1 refs): Body: lions
- **Mummy Lord** (1 refs): Body: mummy lord
...
### post-985.md
**Title:** Alhoon Tactics
- **Death Knight** (1 refs): Body: death knights
- **Knight** (1 refs): Body: knights
- **Lich** (1 refs): Body: lich
- **Necromancer** (1 refs): Body: necromancer
...
- **Mummy** (1 refs): Body: mummies
- **Nightmare** (1 refs): Body: nightmare
- **Skeleton** (2 refs): Body: skeletons, skeleton
- **Vampire** (1 refs): Body: vampires
- **Warhorse** (1 refs): Body: warhorse
- **Warhorse Skeleton** (1 refs): Body: warhorse skeleton
- **Warrior** (1 refs): Body: warrior
- **Wight** (1 refs): Body: wights
- **Wraith** (1 refs): Body: wraiths
- **Zombie** (1 refs): Body: zombies
