...
For bonus actions, the Master Thief can utilize "Cunning Action" to Dash, Disengage, Hide, or engage an Object action, granting it significant tactical options during combat. The unique "Rapid Attack" allows it to strike quickly with its shortsword, underlining its proficiency in both speed and agility. Overall, the Master Thief is a deadly opponent that combines high offensive capabilities with evasiveness and cunning, representing a significant challenge for any adventuring party.</detail>
