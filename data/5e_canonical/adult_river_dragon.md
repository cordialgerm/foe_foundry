...
Finally, the dragon has legendary actions, which allow it to take three actions between other creatures’ turns. These actions include Dart Away, which lets it quickly swim, Lurk to hide, River Surge to create a massive wave causing damage and potentially capsizing vehicles, and Sudden Maelstrom, creating a dangerous storm around it when it is bloodied. The combination of these abilities makes the Adult River Dragon both a fearsome opponent and a cunning adversary in the right circumstances.</detail>
