...
In combat, the Barometz can make two attacks in one turn through its **Multiattack** action, using both its gore and hooves. The **Gore** attack has a +6 to hit and can deal an average of 14 (2d10 + 3) piercing damage, along with a chance to knock a target prone if they fail a DC 14 Strength saving throw. The **Hooves** attack also has a +6 to hit and deals an average of 12 (2d8 + 3) bludgeoning damage. Overall, the Barometz serves as both a formidable adversary and a source of potential aid for those who can utilize its unique abilities effectively.</detail>
