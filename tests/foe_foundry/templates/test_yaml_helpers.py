...
from foe_foundry.damage import DamageType, Condition
from foe_foundry.attack_template import weapon, natural, spell
...
class TestParseCreatureTypesFromYaml:
    ...
    def test_parse_with_additional_creature_types(self):
        ...
        data = {
            ...
            "additional_creature_types": ["Humanoid"]
        }
...
class TestParseRolesFromYaml:
    ...
    def test_parse_with_additional_roles(self):
        ...
        data = {
            "roles": {
                "primary": "Controller",
                "additional": ["Defender", "Skirmisher"]
            }
        }
...
class TestParseDamageImmunitiesFromYaml:
    ...
    def test_damage_immunities_only(self):
        ...
        data = {
            "immunities": {
                "damage_types": ["Fire", "Necrotic", "Poison"]
            }
        }
...
class TestParseSingleAttackFromYaml:
    ...
    def test_parse_basic_weapon_attack(self):
        ...
        assert result is None or hasattr(result, 'name') or hasattr(result, 'display_name')
...
class TestRealYamlDataIntegration:
    ...
    def sample_yaml_files(self):
        ...
        yaml_files = list(templates_dir.glob("*.yml"))[:3]  # Just test with first 3 files
        return yaml_files
