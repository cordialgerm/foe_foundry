...
from foe_foundry.creatures import skeleton
...
@pytest.mark.parametrize("args", skeleton.SkeletonTemplate.generate_options(), ids=_ids)
def test_skeleton_statblocks(args: dict):
    ...
    stats = skeleton.SkeletonTemplate.generate(
