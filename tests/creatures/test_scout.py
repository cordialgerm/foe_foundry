...
from foe_foundry.creatures import scout
...
@pytest.mark.parametrize("args", scout.ScoutTemplate.generate_options(), ids=_ids)
def test_scout_statblocks(args: dict):
    ...
    stats = scout.ScoutTemplate.generate(**args, rng_factory=rng_factory).finalize()
