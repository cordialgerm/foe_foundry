...
from foe_foundry.creatures import guard
...
@pytest.mark.parametrize("args", guard.GuardTemplate.generate_options(), ids=_ids)
def test_guard_statblocks(args: dict):
    ...
    stats = guard.GuardTemplate.generate(**args, rng_factory=rng_factory).finalize()
