...
from foe_foundry.creatures import golem
...
@pytest.mark.parametrize("args", golem.GolemTemplate.generate_options(), ids=_ids)
def test_golem_statblocks(args: dict):
    ...
    stats = golem.GolemTemplate.generate(**args, rng_factory=rng_factory).finalize()
