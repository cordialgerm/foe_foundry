...
from foe_foundry.creatures import assassin
...
@pytest.mark.parametrize("args", assassin.AssassinTemplate.generate_options(), ids=_ids)
def test_assassin_statblocks(args: dict):
    ...
    stats = assassin.AssassinTemplate.generate(
