...
from foe_foundry.creatures import cultist
...
@pytest.mark.parametrize("args", cultist.CultistTemplate.generate_options(), ids=_ids)
def test_cultist_statblocks(args: dict):
    ...
    stats = cultist.CultistTemplate.generate(**args, rng_factory=rng_factory).finalize()
