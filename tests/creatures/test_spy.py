...
from foe_foundry.creatures import spy
...
@pytest.mark.parametrize("args", spy.SpyTemplate.generate_options(), ids=_ids)
def test_spy_statblocks(args: dict):
    ...
    stats = spy.SpyTemplate.generate(**args, rng_factory=rng_factory).finalize()
