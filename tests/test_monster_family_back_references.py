...
class TestMonsterFamilyBackReferences:
    ...
    def test_monster_family_back_references_populated(self):
        ...
        for monster in family_with_monsters.monsters:
            assert (
                monster.family_keys is not None
            ), f"Monster {monster.name} should have family_keys set"
            assert (
                family_with_monsters.key in monster.family_keys
    ...
    def test_monster_info_computed_field_includes_family_names(self):
        ...
        assert (
            family_with_monsters.name in family_names
    ...
    def test_monster_model_has_family_keys(self):
        ...
        if monster_with_family:
            assert (
                monster_with_family.family_keys is not None
            ...
            for family_key in monster_with_family.family_keys:
                ...
                assert family is not None, f"Family with key {family_key} should exist"
