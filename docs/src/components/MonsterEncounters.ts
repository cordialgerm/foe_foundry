...
@customElement('monster-encounters')
export class MonsterEncounters extends LitElement {
  ...
  updated() {
    ...
    if (this.encounterRef.value && this.encounterTask.value?.encounterElement) {
      ...
      if (!this.encounterRef.value.querySelector('[data-monster-encounter]')) {
        const clonedElement = this.encounterTask.value.encounterElement.cloneNode(true) as HTMLElement;
...
declare global {
  interface HTMLElementTagNameMap {
    'monster-encounters': MonsterEncounters;
  }
}