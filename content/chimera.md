...
When running the Chimera encounter, start by using the *Quarelling Heads* ability to determine which head is in charge. This then determines the Chimera's tactics.
