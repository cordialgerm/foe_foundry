...
{{ statblock(statblocks["zombie-brute"]) }}
...
{{ statblock(statblocks["zombie-gravewalker"]) }}
...
{{ statblock(statblocks["zombie-ogre"]) }}
...
{{ statblock(statblocks["zombie-giant"]) }}
